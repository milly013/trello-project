...
func (h *UserHandler) Login(c *gin.Context) {
	...
	captchaSuccess, err := verifyCaptcha(req.CaptchaToken)
	if err != nil || !captchaSuccess {
...
func verifyCaptcha(captchaToken string) (bool, error) {
	secretKey := os.Getenv("RECAPTCHA_SECRET_KEY") // Ovo treba biti postavljeno na environment varijablu
